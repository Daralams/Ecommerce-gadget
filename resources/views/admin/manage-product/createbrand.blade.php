...
<main>
    ...
    <div class="row justify-content-center">
      <div class="col-md-7 col-lg-8">
        ...
        <form method="post" action="/dashboard-admin/brand/addNewBrand">
          @csrf
          
          <div class="row g-3">
            <div class="col-sm-6">
              <label for="Brand" class="form-label">Brand</label>
              <input type="text" class="form-control @error('merk') is-invalid @enderror" name="merk" required value="{{old('merk')}}">
             @error('merk')
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Add Brand</button>
        </form>
      </div>
    </div>
  </main>
